document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        en: {
            ...
            career_title: "// Career",
            career_text: "Full Stack Software Engineer with a strong track record in building high-performance e-commerce platforms and robust enterprise applications. Proven ability to lead complex initiatives, from architecting ultra-fast, scalable storefronts to orchestrating seamless integrations with AWS, ERPs, and CRMs. Currently pushing the boundaries of AI by evaluating and training advanced LLMs at Revelo.",
            ...
            exp_revelo_2: "Working on diverse evaluation and training tasks, including software development, complex problem solving, 3D project refinement, and full-stack SPA development.",
            exp_pave_role_main: "Full Stack Engineer",
            exp_pave_location: ", Campina Grande, PB, Remote",
            exp_pave_date: "Jun 2024 - Sep 2025",
            exp_pave_1: "Architected and built a high-performance event platform for brand campaign engagement and user registration.",
            exp_pave_2: "Engineered seamless frontend-to-backend integrations using AWS, ensuring secure auth and resilient data flows.",
            exp_pave_3: "Developed complex features including media uploads, event creation flows, and scalable data management dashboards.",
            exp_pave_4: "Collaborated closely with design teams to deliver pixel-perfect, highly responsive UX/UI across all devices.",
            exp_pave_5: "Maintained rigorous code quality, significantly reducing bug rates and improving overall system stability.",
            ...
            exp_inside_1: "Led team to build e-commerce platform using Deco.cx, achieving a perfect 100 PageSpeed score and enabling marketing campaigns that significantly boosted sales.",
            ...
            exp_wave_3: "Shipped fast, reusable pages with a perfect 100 PageSpeed score using Deco.cx & CMS integration.",
            ...
            proj_ameo_desc: "Scalable full-stack platform for pet care management. Engineered to deliver a seamless user experience, combining robust architecture (React, Node, MongoDB) with real-time state management and high-precision data validation.",
            proj_mcp_title: "2. MCPWeather - Custom Data Protocol",
            proj_mcp_desc: "High-performance service for real-time weather data consumption. Designed from the ground up with clean architecture in Node.js and TypeScript, highlighting custom protocol implementation and advanced caching strategies.",
            proj_chess_title: "3. Chess Game Engine (Ruby)",
            proj_chess_desc: "High-complexity chess engine built in Ruby. A practical demonstration of software architecture and Object-Oriented Design (OOP) mastery, implementing complete advanced game logic, including move validation and checkmate detection.",
        ...
        pt: {
            ...
            career_text: "Engenheiro de Software Full Stack com sólido histórico na criação de plataformas de e-commerce de alta performance e aplicações corporativas robustas. Comprovada capacidade de liderar iniciativas complexas, desde a arquitetura de lojas escaláveis e ultrarrápidas até integrações eficientes com AWS, ERPs e CRMs. Atualmente expandindo as fronteiras da Inteligência Artificial através do treinamento técnico e avaliação de LLMs avançados na Revelo.",
            ...
            exp_revelo_2: "Trabalhando em diversas tarefas de avaliação e treinamento, incluindo desenvolvimento de software, resolução de problemas complexos, refinamento de projetos 3D e desenvolvimento de SPAs full-stack.",
            exp_pave_role_main: "Engenheiro Full Stack",
            exp_pave_location: ", Campina Grande, PB, Remoto",
            exp_pave_date: "Jun 2024 - Set 2025",
            exp_pave_1: "Arquitetei e construí uma plataforma de eventos de alta performance para engajamento de campanhas de marcas.",
            exp_pave_2: "Desenvolvi integrações robustas de frontend com backend na AWS, garantindo autenticação segura e resiliência de dados.",
            exp_pave_3: "Implementei funcionalidades complexas, incluindo uploads de mídia, fluxos de criação de eventos e dashboards de gestão.",
            exp_pave_4: "Trabalhei em estreita colaboração com o design para entregar uma UX/UI impecável e responsiva em todos os dispositivos.",
            exp_pave_5: "Mantive um alto rigor na qualidade do código, reduzindo significativamente a taxa de bugs e melhorando a estabilidade.",
            ...
            exp_inside_1: "Liderei equipe na construção de plataforma e-commerce usando Deco.cx, alcançando PageSpeed 100 e viabilizando ações de marketing que alavancaram as vendas.",
            ...
            exp_wave_3: "Lancei páginas rápidas e reutilizáveis com nota 100 no PageSpeed usando Deco.cx e integração CMS.",
            ...
            proj_ameo_desc: "Plataforma full-stack escalável para gerenciamento de cuidados de pets. Desenvolvida para oferecer uma experiência de usuário fluida, combinando arquitetura robusta (React, Node, MongoDB) com gestão de estado em tempo real e validação de dados de alta precisão.",
            proj_mcp_title: "2. MCPWeather - Protocolo de Dados Customizado",
            proj_mcp_desc: "Serviço de altíssima performance para consumo de dados climáticos em tempo real. Projetado do zero com uma arquitetura limpa em Node.js e TypeScript, destacando-se pela implementação de protocolos customizados e estratégias avançadas de cache.",
            proj_chess_title: "3. Chess Game Engine (Ruby)",
            proj_chess_desc: "Motor de xadrez de alta complexidade criado em Ruby. Uma demonstração prática de domínio em arquitetura de software e Design Orientado a Objetos (OOP), implementando toda a lógica avançada do jogo, incluindo validação de movimentos e detecção de xeque-mate.",
